...
INCLUDE %SwiftForth/src/ide/ul/osx/exception            \ Signal display registers
...
INCLUDE %SwiftForth/src/ide/ul/osx/sigcont              \ SIGCONT handler
...
LIBRARY libc.dylib
INCLUDE %SwiftForth/src/ide/ul/osx/timer                \ System timer
...
INCLUDE %SwiftForth/src/ide/ul/osx/requires             \ Load lib source
INCLUDE %SwiftForth/src/ide/envq                        \ ANS environment queries

LIBRARY libpthread.dylib
...
INCLUDE %SwiftForth/src/ide/ul/osx/save                 \ Save turnkey image
